...
if ( ! function_exists( 'hsc2020_setup' ) ) :
	...
	function hsc2020_setup() {
		 ...
		 * If you're building a theme based on hsc2020, use a find and replace
		 * to change 'hsc2020' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'hsc2020', get_template_directory() . '/languages' );
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'hsc2020_custom_background_args',
				array(
 ...
 */
function hsc2020_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'hsc2020' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'hsc2020' ),
...
add_action( 'widgets_init', 'hsc2020_widgets_init' );
